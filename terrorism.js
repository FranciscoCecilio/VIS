//var dataset, full_dataset, data_bycountry_norm;

var padding = 60;

var svg_choropleth, svg_circlepacking, svg_line_chart, svg_pc;
...
function gen_choropleth() {
  ...
  d3.json("terrorism_attacks.json").then(function(data){
    svg_choropleth = d3
      ...
      var dataGroup = d3.rollup(data, v=>d3.sum(v, d=>d.Fatalities),d=>d["Country Name"]);
...
function gen_line_chart() {
  ...
  d3.json("terrorism_attacks.json").then(function(dataset){
